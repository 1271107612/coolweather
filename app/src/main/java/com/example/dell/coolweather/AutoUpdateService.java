...
public class AutoUpdateService extends Service {
    ...
    private void updateWeather() {
        ...
        if (weatherString != null) {
            ...
            String weatherUrl = "http://1271107612.tech/api/weather?cityid=" + weatherId + "&key=bc0418b57b2d4918819d3974ac1285d9";
    ...
    private void updateBingPic(){
        String requestBingPic="http://1271107612.tech/api/bing_pic";
